...
//  adicionar o evento click em todas as caixas
for (let i = 0; i < boxes.length; i++) {
  ...
  boxes[i].addEventListener('click', function () {
    ...
    if (this.childNodes.length == 0) {
      // adiconar o lemeneto dentro da caixa
      // vamos clonar o elemnto
